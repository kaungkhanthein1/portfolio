...
export const HeroSection = () => {
  return (
    ...
    >
      ...
      <a
        href="#about"
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce cursor-pointer hover:text-glow transition-all duration-300"
